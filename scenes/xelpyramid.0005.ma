...
//Last modified: Mon, Oct 12, 2015 04:01:08 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.6612755450732841 100.226285860616 68.679501099051336 ;
	setAttr ".r" -type "double3" -36.33835278410767 2416.9999999913621 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1C6CAF31-4CDA-5B1A-773F-70AF1D32858C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 44.453036867022327;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 26.229294758650255 73.885526829983888 76.734623957951271 ;
...
createNode mesh -n "pCubeShape4" -p "pCube4";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.54333186149597168 0.12042525410652161 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pPlane25Shape" -p "pPlane25";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.95409035682678223 0.9758075475692749 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 42 ".pt";
	setAttr ".pt[214]" -type "float3" 2.5254586 2.1625092 1.8593476 ;
	setAttr ".pt[313]" -type "float3" -2.5350652 0.21825492 -1.1362597 ;
	setAttr ".pt[337]" -type "float3" 0.087980591 -4.9908271 -4.0861154 ;
	setAttr ".pt[358]" -type "float3" -0.02960185 1.8724037 1.3748097 ;
	setAttr ".pt[359]" -type "float3" 1.7370341 -1.0647975 -1.5404968 ;
	setAttr ".pt[360]" -type "float3" -2.0163751 -2.7374494 -2.6510205 ;
	setAttr ".pt[381]" -type "float3" -0.062916413 4.0701895 2.9220507 ;
	setAttr ".pt[382]" -type "float3" -5.7965379 -4.2451148 -2.7175355 ;
	setAttr ".pt[383]" -type "float3" -6.7974358 2.3342752 1.6226354 ;
	setAttr ".pt[384]" -type "float3" 1.1318393 -2.5708406 -2.1524367 ;
	setAttr ".pt[409]" -type "float3" 7.1419768 -2.3841858e-007 0.1537782 ;
	setAttr ".pt[410]" -type "float3" -13.02742 3.7757607 2.374989 ;
	setAttr ".pt[411]" -type "float3" 0.73527026 0 0.015831541 ;
	setAttr ".pt[412]" -type "float3" -7.1222839 0 -0.15335414 ;
	setAttr ".pt[418]" -type "float3" 2.5254586 2.1625092 1.8593476 ;
	setAttr ".pt[420]" -type "float3" 0.73527026 0 0.015831541 ;
	setAttr ".pt[421]" -type "float3" -7.1222839 0 -0.15335414 ;
	setAttr ".pt[436]" -type "float3" -2.5350652 0.21825492 -1.1362597 ;
	setAttr ".pt[467]" -type "float3" 0.087980591 -4.9908271 -4.0861154 ;
	setAttr ".pt[472]" -type "float3" -0.02960185 1.8724037 1.3748097 ;
	setAttr ".pt[474]" -type "float3" 1.7370341 -1.0647975 -1.5404968 ;
	setAttr ".pt[475]" -type "float3" -2.0163751 -2.7374492 -2.6510205 ;
	setAttr ".pt[484]" -type "float3" -0.062916413 4.0701895 2.9220507 ;
	setAttr ".pt[485]" -type "float3" -5.7965379 -4.2451148 -2.7175355 ;
	setAttr ".pt[486]" -type "float3" -6.7974358 2.3342752 1.6226354 ;
	setAttr ".pt[487]" -type "float3" 1.1318393 -2.5708406 -2.1524367 ;
	setAttr ".pt[495]" -type "float3" 7.1419768 -2.3841858e-007 0.1537782 ;
	setAttr ".pt[496]" -type "float3" -13.046197 3.7757607 3.2470536 ;
	setAttr ".pt[671]" -type "float3" 0.038330466 -2.4146926 -1.7801963 ;
	setAttr ".pt[672]" -type "float3" 0.038330466 -2.4146926 -1.7801963 ;
	setAttr ".pt[682]" -type "float3" -0.053745426 1.6146832 2.4961195 ;
	setAttr ".pt[683]" -type "float3" -0.053745426 1.6146832 2.4961195 ;
	setAttr ".pt[726]" -type "float3" 0 -3.0780759 0 ;
	setAttr ".pt[727]" -type "float3" 0 -3.0780759 0 ;
	setAttr ".dr" 1;
...
createNode mesh -n "pPlane28Shape" -p "pPlane28";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.77885216474533081 0.062297772616147995 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 22 ".pt";
	setAttr ".pt[412]" -type "float3" 9.3132257e-010 0 -2.9802322e-008 ;
	setAttr ".pt[413]" -type "float3" 9.3132257e-010 0 -2.9802322e-008 ;
	setAttr ".pt[414]" -type "float3" 9.3132257e-010 0 -2.9802322e-008 ;
	setAttr ".dr" 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "44AD5E25-4D39-A780-0CBD-6C9FE2251DFC";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "402960F7-4FB3-62D0-79B7-F19E6ED3932C";
createNode displayLayer -n "defaultLayer";
	rename -uid "E97E8083-490B-9E29-D36E-0B9AB4A47230";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "680AC99C-4D5B-F888-8BFC-2480E2916D06";
...
createNode polyTweak -n "polyTweak118";
	...
	setAttr ".uopa" yes;
	setAttr -s 2 ".tk[679]" -type "float3"  -2.90045691 0 -0.062451474;
...
createNode polyTweak -n "polyTweak119";
	...
	setAttr ".uopa" yes;
	setAttr -s 25 ".tk";
	setAttr ".tk[74]" -type "float3" 3.320435 -1.9073486e-006 -0.46582383 ;
	setAttr ".tk[75]" -type "float3" 3.3204336 -1.9073486e-006 -0.46582383 ;
	setAttr ".tk[76]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[77]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[78]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[79]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[80]" -type "float3" 3.3204336 -1.9073486e-006 -0.46582383 ;
	setAttr ".tk[81]" -type "float3" 3.3204336 -1.9073486e-006 -0.46582383 ;
	setAttr ".tk[82]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[83]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[84]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[85]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[86]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[87]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[88]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[89]" -type "float3" 3.3312807 -1.9073486e-006 -3.1201398 ;
	setAttr ".tk[90]" -type "float3" 0.51201749 -1.9073486e-006 -3.1316609 ;
	setAttr ".tk[91]" -type "float3" 0.51201749 -1.9073486e-006 -3.1316609 ;
	setAttr ".tk[92]" -type "float3" 0.51201749 -1.9073486e-006 -3.1316609 ;
	setAttr ".tk[93]" -type "float3" 0.51201749 -1.9073486e-006 -3.1316609 ;
...
createNode polyTweak -n "polyTweak121";
	...
	setAttr ".uopa" yes;
	setAttr -s 20 ".tk";
	setAttr ".tk[122]" -type "float3" -0.067086302 0 0.28571028 ;
	setAttr ".tk[123]" -type "float3" -1.243354 0 0.2809034 ;
	setAttr ".tk[124]" -type "float3" -1.6516696 0 0.27923471 ;
	setAttr ".tk[125]" -type "float3" -1.6516696 0 0.27923471 ;
	setAttr ".tk[126]" -type "float3" -0.19200203 0 0.2851997 ;
	setAttr ".tk[127]" -type "float3" -0.61257654 0 0.28348106 ;
	setAttr ".tk[128]" -type "float3" -0.61257654 0 0.28348106 ;
	setAttr ".tk[129]" -type "float3" -2.0722442 0 0.27751607 ;
	setAttr ".tk[130]" -type "float3" -2.0673301 0.87173307 -0.9249869 ;
	setAttr ".tk[131]" -type "float3" -2.0673301 0.87173307 -0.9249869 ;
	setAttr ".tk[132]" -type "float3" -2.0673301 0.87173307 -0.9249869 ;
	setAttr ".tk[133]" -type "float3" -2.0628879 0.87173307 -2.012017 ;
	setAttr ".tk[134]" -type "float3" -2.0633583 0 -1.8968735 ;
	setAttr ".tk[135]" -type "float3" -0.2831738 0 0.21389264 ;
...
connectAttr "polySplitRing122.out" "pPlane25Shape.i";
...
connectAttr "polyBevel1.out" "pPlane28Shape.i";
